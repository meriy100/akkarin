class ShortCcsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @short_cc.save
        format.html { redirect_to short_cc_path(@short_cc), notice: 'Short cc was successfully created.' }
      else
  ...
  def update
    respond_to do |format|
      if @short_cc.update(short_cc_params)
        format.html { redirect_to short_cc_path(@short_cc), notice: 'Short cc was successfully updated.' }
      else
  ...
  def destroy
    @short_cc.destroy
    respond_to do |format|
      format.html { redirect_to short_ccs_path, notice: 'Short cc was successfully destroyed.' }
    end
  end
