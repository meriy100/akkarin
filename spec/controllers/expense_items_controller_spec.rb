...
RSpec.describe ExpenseItemsController, type: :controller do
  ...
  # ExpenseItemsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested expense_item as @expense_item" do
      expense_item = ExpenseItem.create! valid_attributes
      get :show, {:id => expense_item.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested expense_item as @expense_item" do
      expense_item = ExpenseItem.create! valid_attributes
      get :edit, {:id => expense_item.to_param}, valid_session
      expect(assigns(:expense_item)).to eq(expense_item)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new ExpenseItem" do
        expect {
          post :create, {:expense_item => valid_attributes}, valid_session
      ...
      it "redirects to the created expense_item" do
        post :create, {:expense_item => valid_attributes}, valid_session
        expect(response).to redirect_to(ExpenseItem.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved expense_item as @expense_item" do
        post :create, {:expense_item => invalid_attributes}, valid_session
        expect(assigns(:expense_item)).to be_a_new(ExpenseItem)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested expense_item" do
        expense_item = ExpenseItem.create! valid_attributes
        put :update, {:id => expense_item.to_param, :expense_item => new_attributes}, valid_session
        expense_item.reload
      ...
      it "assigns the requested expense_item as @expense_item" do
        expense_item = ExpenseItem.create! valid_attributes
        put :update, {:id => expense_item.to_param, :expense_item => valid_attributes}, valid_session
        expect(assigns(:expense_item)).to eq(expense_item)
      end
      ...
      it "redirects to the expense_item" do
        expense_item = ExpenseItem.create! valid_attributes
        put :update, {:id => expense_item.to_param, :expense_item => valid_attributes}, valid_session
        expect(response).to redirect_to(expense_item)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the expense_item as @expense_item" do
        expense_item = ExpenseItem.create! valid_attributes
        put :update, {:id => expense_item.to_param, :expense_item => invalid_attributes}, valid_session
        expect(assigns(:expense_item)).to eq(expense_item)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested expense_item" do
      expense_item = ExpenseItem.create! valid_attributes
      expect {
        delete :destroy, {:id => expense_item.to_param}, valid_session
      }.to change(ExpenseItem, :count).by(-1)
    end
    ...
    it "redirects to the expense_items list" do
      expense_item = ExpenseItem.create! valid_attributes
      delete :destroy, {:id => expense_item.to_param}, valid_session
      expect(response).to redirect_to(expense_items_url)
    end
  end
